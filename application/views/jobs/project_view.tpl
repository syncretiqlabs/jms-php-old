                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="border-bottom py-2 row">
                                <div class="col-sm-8">
                                    <h4>Basic Information | {project.Name}</h4>
                                </div>
                                {if isset($logged_in_user.UserRole) && $logged_in_user.UserRole != 'member'}
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <label for="contract_hours"
                                                class="contract_hours col-sm-3  text-right"  >Time In
                                                Hours:</label>
                                            <div class="col-sm-3">
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            <label for="" class="col-3  text-right"></label>
                                            <div class="col-sm-5">
                                                {if isset($project.Suburb)} {$project.Suburb} {/if}
                                            </div>
                                            <div class="col-sm-2">
                                                {if isset($project.City)} {$project.City} {/if}
                                            </div>
                                        </div>
                                    </div>
                                </div>
