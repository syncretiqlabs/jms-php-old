        ...
        <div class="searchBar">
            <form class="form" method="GET" action="{$host_url}/index.php/project/project/encrypt">
                <div class="input-group mb-3 input-group-lg">
                    ...
                    <a href="{$host_url}/index.php/project/project_detail" class="btn btn-md btn-primary mr-1 p-3"><i
            ...
            <table class="table table-hover table-responsive-sm" id="contactList">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Customer <a href="#" class="caret"><i class="icofont-caret-down"></i></a></th>
