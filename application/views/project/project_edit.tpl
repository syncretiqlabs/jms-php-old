                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <form class="mt-2" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="status" class="form-control" name="status">
                                            ...
                                            <option value="new" {if isset($project.Status) && $project.Status=="new"} selected="selected" {/if} {if isset($contactDetail.Id) && $contactDetail.Id!=''} selected="selected" {/if} selected>New</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="contract_hours"
                                                ...
                                                {if isset($project.Type) && $project.Type == 'onetime'}style="display:none;"
                                                    {else if isset($project.Type) && $project.Type == 'contract'}
                                                    style=""
                                                    {else}
                                                    style="display:none;"
                                                    {/if} >Time In
                                ...
                                <div class="form-group row">
                                {if $logged_in_user.Email === 'shaswat2883@gmail.com'}
                                    <label for="" class="col-sm-3 col-form-label text-right">Customer Name1</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="customer_id_ac" lass="form-control" value="" name="hello" placeholder="type something">
                                    </div>
                                {else}
                                    ...
                                    <div class="col-sm-9">
                                        <select id="customer_id" class="form-control" name="customer_id">
                                            ...
                                            <option value="{$value.Id}" {if isset($project.ContactId) && $project.ContactId==$value.Id} selected="selected" {/if} {if isset($contactDetail.Id) && $contactDetail.Id==$value.Id} selected="selected" {/if}>
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            <label for="" class="col-3 col-form-label text-right">Address{if isset($contactDetail["Address1"]) && $contactDetail["Address1"]!=''}<span id="sameAsContact"><a href="javascript:void(0);" onclick="javascript:setProjectAddress();">(Same As Contact)</a>{/if}</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="textarea" class="form-control" name="description" placeholder="Description">{if isset($project.Description)} {$project.Description} {/if}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="order_no" name="order_no" {if isset($project.OrderId)} value="{$project.OrderId}" {/if} placeholder="Order no">
                                            </div>
                                            <label for="" class="col-sm-3 col-form-label text-right">Code /Job
                                                no:</label>
                                            <div class="col-sm-3"> 
                                                <input type="text" class="form-control" id="job_no" name="job_no" {if isset($project.JobId)} value="{$project.JobId}" {/if} placeholder="Job no">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="startdate" {if isset($project.StartDate)} value="{$project.StartDate}" {/if} class="form-control" value="" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="enddate" {if isset($project.EndDate)} value="{$project.EndDate}" {/if} class="form-control" value="" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" placeholder="Notes if required" name="notes" {if isset($project.Notes)} value="{$project.Notes}" {/if}>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <button type="button" onclick="javascript:document.location='{$host_url}/index.php/project/project'" class="btn btn-lg btn-secondary">Cancel</button>
                                    </div>
                                </div>
                            </form>
